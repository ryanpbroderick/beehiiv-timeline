...
def import_all_posts(max_issues: Optional[int] = None, max_pages: Optional[int] = None, limit: int = 50, **kwargs) -> int:
    ...
    Args:
        max_issues: Stop after processing this many posts (useful for testing).
        max_pages: Stop after fetching this many pages (useful for testing).
        limit: Beehiiv API page size.
        kwargs: Ignored. (Prevents crashes if callers pass unexpected args.)
    """
    ...
    while True:
        ...
        try:
            response = fetch_beehiiv_posts(limit=limit, page=page)
            ...
            for post in posts:
                ...
                # ✅ EARLY STOP (inside the inner loop)
